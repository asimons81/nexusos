...
_OVERLAY_FILES = (
    ...
    "src/nexusos/parsing/markdown.py",
    "src/nexusos/parsing/plaintext.py",
    "src/nexusos/parsing/wikilinks.py",
    ...
    "src/nexusos/services/vault_lint_service.py",
