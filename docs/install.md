...
**Current release:** `v0.1.0-rc.1` (runtime version `0.1.0-rc.1`,
package version `0.1.0rc1`)

> [!IMPORTANT]
> NexusOS is release-candidate software. The `v0.1` core feature scope is implemented,
> and release hardening is complete for this candidate. See
...
uv run nexusos version        # => nexusos 0.1.0-rc.1
```
...
Download `nexusos-0.1.0rc1-py3-none-any.whl` from the release artifacts (or
build it per [docs/releasing.md](releasing.md)), then:

```bash
python3 -m venv .venv
source .venv/bin/activate        # Windows: .venv\Scripts\activate
pip install nexusos-0.1.0rc1-py3-none-any.whl
...
pip install nexusos-0.1.0rc1.tar.gz
...
All commands above were verified against the `0.1.0rc1` wheel and sdist in
...
Artifacts (v0.1.0-rc.1, build commit `<TBD>`):

- `nexusos-0.1.0rc1-py3-none-any.whl`
- `nexusos-0.1.0rc1.tar.gz`
